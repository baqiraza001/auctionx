    ...
    <div class="row p-6 p-md-3">
      <div class="col-md-5">
        <a href="./auction/<?= $model['products'][0]['id_barang']; ?>" style="display: block;width:100%;max-height: 260px;">
          <img class="car-thumbs img-fluid" src="<?= !empty($mainSliderImages[0]['name']) ? SITE_BASE_URL.AUTCTION_IMAGES_PATH.$mainSliderImages[0]['name']  : 'https://cdn.imagin.studio/getImage' ?>" alt="Image" width="400" height="300">
        </a>
      </div>
      <div class="col">
